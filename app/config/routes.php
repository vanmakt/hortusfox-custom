...
return [
    ...
    /** API Controller */
    array('/api/plants/get', 'GET', 'api@get_plant'),
    array('/api/plants/add', 'POST', 'api@add_plant'),
    array('/api/plants/update', 'POST', 'api@update_plant'),
    array('/api/plants/remove', 'POST', 'api@remove_plant'),
    array('/api/plants/list', 'GET', 'api@get_plant_list'),
    array('/api/plants/search', 'GET', 'api@search_plants'),
    array('/api/plants/attributes/add', 'POST', 'api@add_attribute'),
    array('/api/plants/attributes/edit', 'POST', 'api@edit_attribute'),
    array('/api/plants/attributes/remove', 'POST', 'api@remove_attribute'),
    array('/api/plants/photo/update', 'POST', 'api@update_plant_photo'),
    array('/api/plants/gallery/list', 'GET', 'api@list_plant_gallery_photos'),
    array('/api/plants/gallery/add', 'POST', 'api@add_plant_gallery_photo'),
    array('/api/plants/gallery/edit', 'POST', 'api@edit_plant_gallery_photo'),
    array('/api/plants/gallery/remove', 'POST', 'api@remove_plant_gallery_photo'),
    array('/api/plants/log/add', 'POST', 'api@add_plant_log_entry'),
    array('/api/plants/log/edit', 'POST', 'api@edit_plant_log_entry'),
    array('/api/plants/log/remove', 'POST', 'api@remove_plant_log_entry'),
    array('/api/plants/log/fetch', 'GET', 'api@fetch_plant_log_entries'),
    array('/api/locations/list', 'GET', 'api@fetch_location_list'),
    array('/api/locations/info', 'GET', 'api@fetch_location_info'),
    array('/api/tasks/fetch', 'GET', 'api@fetch_tasks_list'),
    array('/api/tasks/add', 'POST', 'api@add_task'),
    array('/api/tasks/edit', 'POST', 'api@edit_task'),
    array('/api/tasks/remove', 'POST', 'api@remove_task'),
    array('/api/inventory/fetch', 'GET', 'api@fetch_inventory'),
    array('/api/inventory/add', 'POST', 'api@add_inventory_item'),
    array('/api/inventory/edit', 'POST', 'api@edit_inventory_item'),
    array('/api/inventory/amount/inc', 'POST', 'api@inc_inventory_item'),
    array('/api/inventory/amount/dec', 'POST', 'api@dec_inventory_item'),
    array('/api/inventory/remove', 'POST', 'api@remove_inventory_item'),
    array('/api/calendar/fetch', 'GET', 'api@fetch_calendar_entries'),
    array('/api/calendar/add', 'POST', 'api@add_calendar_entry'),
    array('/api/calendar/edit', 'POST', 'api@edit_calendar_entry'),
    array('/api/calendar/remove', 'POST', 'api@remove_calendar_entry'),
    array('/api/chat/fetch', 'GET', 'api@fetch_chat_messages'),
    array('/api/chat/message/add', 'POST', 'api@add_chat_message'),
    array('/api/backup/export', 'GET', 'api@export_backup'),
